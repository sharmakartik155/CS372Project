...
function login_signup_validate(event) {
	...
	var input_birthday = event.currentTarget.birthday.value;
	...
	document.getElementById("signup_birthday_message").innerHTML = "";
...
//Birthday validation
	if (input_birthday == null || input_birthday == ""){
		document.getElementById("signup_birthday_message").innerHTML = "Birthday is empty. ";
		result = false;
	}
	else {
		if (date_v1.test(input_birthday) == false)
		{
			document.getElementById("signup_birthday_message").innerHTML = "Use format \"YYYY-MM-DD\"";
			result = false;
		} else if (date_v2.test(input_birthday) == false)
		{
			document.getElementById("signup_birthday_message").innerHTML = "Date is invalid.";
			result = false;
		}
	}
